...
//    }
    ...
    public void Select_BK_SELECT(String BK_SELECT) throws InterruptedException, IOException
 	{
 		...
 		utilities.PassScreenshot.Getscreenshot11("select banklist", "Multilcurrency");
     ...
     */
 	public void Enter_n_desc(String n_desc) throws InterruptedException
 	{
      ...
      //     Thread.sleep(2000);
 		...
 		utilities.PassScreenshot.Getscreenshot11("Enter Description", "Multilcurrency");
 		//Thread.sleep(1000);
 		elem.sendKeys(Keys.TAB);
     ...
     */
 	public void Enter_Recived_amt(String Recived_amt) throws InterruptedException
 	{
 		...
 		//Thread.sleep(1000);
 		utilities.PassScreenshot.Getscreenshot11("Enter Received Amount", "Multilcurrency");
 		elem.sendKeys(Keys.TAB);
...
//  	elem.sendKeys(Keys.TAB); 
     ...
     */
 	...
 	//	Thread.sleep(2000);
 		elem.sendKeys(Keys.TAB);
 		utilities.PassScreenshot.Getscreenshot11("Enter spnt amount", "Multilcurrency");
    ...
    public void Select_Select_VATRate(String Select_VATRate) throws InterruptedException
 	{
		...
		Select dropdown = new Select(elem);
 		...
 		utilities.PassScreenshot.Getscreenshot11("Vatrate Type", "Multilcurrency");
...
//         }
 	        ...
 	        utilities.PassScreenshot.Getscreenshot11("sselected ledger code", "Multilcurrency");
 	         Thread.sleep(3000);
...
//		elem.click();
	...
	public void no_vat_scheme_multicurrency(String ste) throws InterruptedException
	
	{
		
		 m_Driver.findElement(By.xpath("//*[@id='tableID']/tbody/tr[1]/td[12]/span/span[1]/span")).click();
		 Thread.sleep(1000);
		 WebElement elem3=jsWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/span/span/span[1]/input")));
		 elem3.sendKeys(ste);
		 elem3.sendKeys(ste);
		 System.out.println("selected ledger code is"+ste);
...
//		 elem4.sendKeys(Keys.ENTER);
		 jsExec.executeScript("arguments[0].click()", elem4);
