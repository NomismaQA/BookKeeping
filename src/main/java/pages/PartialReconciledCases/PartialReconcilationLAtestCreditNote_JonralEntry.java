...
public class PartialReconcilationLAtestCreditNote_JonralEntry extends BasePage
{
	String Rpno=" ";
	public PartialReconcilationLAtestCreditNote_JonralEntry (WebDriver driver)
	{
		super(driver);
	}
