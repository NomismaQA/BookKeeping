...
public class nBANKTRN_Subcontractor extends BasePage
{
     public static String Prno1;
     public static String savemassg;
     
	public nBANKTRN_Subcontractor (WebDriver driver)
	{
		super(driver);
	}
	...
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/AccountUI/BankTranEditor.aspx?FYCode=52444&CompanyCode=13236&menuid=0");
...
//		elem.click();
		...
		pages.Subcontractorbill re= new pages.Subcontractorbill(m_Driver);
		String client = c.client1();
		
		String Remv = re.vatrate1();
		String t = "Bank";
		savemassg=t+client+Remv;
		...
		Screenshotcapture.captureAsImage(m_Driver, savemassg);
	     ...
	     String stn=arr[2];
	      Prno1=stn.substring(1);
	    System.out.println("Transaction number is"    +Prno1);	
	...
	{
		System.out.println("Confirmation "+Prno1);	
		return Prno1;
