...
public class newbank extends BasePage
{
	...
	private By BankingElem = By.xpath("//*[@id='ctl00_SideMenu1_bankingMenu']");
	//private By BankingElem = By.xpath("//*[contains(text(),'Banking')]");

	private By New_Elem = By.xpath("//A[@class='text-white']");

	private By New_Bank_AccountElem = By.xpath("//A[text()='New Bank Account']");

	private By BankMasterElem = By.xpath("//SELECT[@name='ctl00$cPH$ddlBankMaster']");

	private By BankAccountNameElem = By.xpath("//INPUT[@name='ctl00$cPH$txtBankAccountName']");

	private By AccTypeElem = By.xpath("//SELECT[@name='ctl00$cPH$dd_AccType']");

	private By AccNoElem = By.xpath("//INPUT[@name='ctl00$cPH$txt_AccNo']");
     ...
     */
    public void Select_BankMaster(String BankMaster)
 	{
