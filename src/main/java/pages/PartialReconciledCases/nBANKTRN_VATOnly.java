...
public class nBANKTRN_VATOnly extends BasePage
{
     public static String krno1;
     public static String savemassg;
     
	public nBANKTRN_VATOnly (WebDriver driver)
	{
		super(driver);
	}
...
//		elem.click();
		...
		Supplier_pages.VATOnlyBillSToFRS re= new Supplier_pages.VATOnlyBillSToFRS(m_Driver);
