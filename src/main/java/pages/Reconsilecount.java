...
/*get row count*/
		   ...
		   // SaleInvoice in = new SaleInvoice(m_Driver);
		    
	          rpno=t.confirmation();
	        // String InvoiceNo = in.message(); 
		rowcount = m_Driver.findElements(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[3]/div/div/div/table/tbody/tr[2]/td/div[2]/table/tbody/tr[1]/td/div/table/tbody/tr")).size();
		int cl = rowcount-1;
		...
		if(j>9)
			{
				...
				WebElement ele= m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl"+jj+"_cbSelect']"));
...
//	   
//    }	
//	    //*[@id="ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl08_cbSelect"]
//                Thread.sleep(2000);
//	        WebElement rec= m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_lnkReconcile']"));
//	        jsExec.executeScript("arguments[0].click();", rec);
////	       	       WebElement t= m_Driver.findElement(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[1]/div"));
////			 System.out.print("confirmation" +t);
//	    	      //a[@id="ctl00_cphFooter_btnReconcile"]
//	      //  m_Driver.switchTo().frame(getWebElement(By.xpath("//a[@id='ctl00_cphFooter_btnReconcile']")));
...
//	//  WebElement elem12 = m_Driver.findElement(By.xpath("//a[contains(text(), ' Reconcile')]"));
//	  //*[@id="ctl00_cphFooter_btnReconcile"]
//		//jsExec.executeScript("arguments[0].click();", elem12);
//	      //  Thread.sleep(1000);
//	   // m_Driver.findElement(By.xpath("//a[contains(text(), ' Reconcile')]")).click();
//	   
...
//
//		//elem.click();
//		WebElement elem1 = m_Driver.findElement(By.xpath("//*[@id='ctl00_cphFooter_btnReconcile']"));
//		jsExec.executeScript("arguments[0].click();", elem1);
//          	
//
