...
public class BankRuleCr_Outofscope_Both extends BasePage
{


	HashMap<String, String>hm=new HashMap<String,String>();
	public static String out_Outs_Both="";
	public static String out2_Outs_Both="";
	
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Outofscope_Both (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
     ...
     * Save rule data
     */
    public void AS_Enter_Data() throws InterruptedException
    {
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("outscop"+i+"both");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("OutS"+j+"Both");
	...
	public void GetTData() throws InterruptedException
	{
		...
		int Size1=dataa.size();
...

			{
				...
				{
					out_Outs_Both=out_Outs_Both+"~"+dd.getKey();
					out2_Outs_Both=out2_Outs_Both+"~"+dd.getValue();
...
System.out.println("Done ");
	...
	public String out_Outs_Both()
	{
		return out_Outs_Both;
		
	}
	public String out2_Outs_Both()
	{
		return out2_Outs_Both;
