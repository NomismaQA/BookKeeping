...
public class BankRuleCr_Reducedrte_Credit extends BasePage
{

	   
    HashMap<String, String>hm=new HashMap<String,String>();
	public static String out_RR_CR="";
	public static String OUT2_RR_CR="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Reducedrte_Credit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Rd"+i+"CR");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("RR"+j+"CR");
	...
	public void GetTData() throws InterruptedException
	{
		...
		int Size1=dataa.size();
...

			{
				...
				{
					out_RR_CR=out_RR_CR+"~"+dd.getKey();
					OUT2_RR_CR=OUT2_RR_CR+"~"+dd.getValue();
...
System.out.println("Done ");
	...
	public String out_RR_CR()
	{
		return out_RR_CR;
		
	}
	public String OUT2_RR_CR()
	{
		return OUT2_RR_CR;
