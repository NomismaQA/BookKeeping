...
public class BankRuleCr_Stdard_Debit extends BasePage
{
	 HashMap<String, String>hm=new HashMap<String,String>();
		public static String out_Stand_Dr="";
	  	public static String out2_Stand_Dr="";
	
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Stdard_Debit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("St"+i+"dr");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("SR"+j+"Dr");
 	...
 	public void GetTData() throws InterruptedException
    	{
    		...
    		int Size1=dataa.size();
...

    			{
    				...
    				{
    					out_Stand_Dr=out_Stand_Dr+"~"+dd.getKey();
    					out2_Stand_Dr=out2_Stand_Dr+"~"+dd.getValue();
    ...
    System.out.println("Done ");
    	...
    	public String out_Stand_Dr()
    	{
    		return out_Stand_Dr;
    		
    	}
    	public String out2_Stand_Dr()
    	{
    		return out2_Stand_Dr;
