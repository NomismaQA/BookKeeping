...
public class BankRuleCr_ZroRate_Credit extends BasePage
{
	   HashMap<String, String>hm=new HashMap<String,String>();
		public static String out_Zr_Cr="";
		public static String out2_Zr_Cr="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_ZroRate_Credit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Zcr"+i+"cr");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("ZR"+j+"CR");
	...
	public void GetTData() throws InterruptedException
	{
		...
		int Size1=dataa.size();
...

			{
				...
				{
					out_Zr_Cr=out_Zr_Cr+"~"+dd.getKey();
					out2_Zr_Cr=out2_Zr_Cr+"~"+dd.getValue();
...
System.out.println("Done ");
	...
	public String out_Zr_Cr()
	{
		return out_Zr_Cr;
		
	}
	public String out2_Zr_Cr()
	{
		return out2_Zr_Cr;
