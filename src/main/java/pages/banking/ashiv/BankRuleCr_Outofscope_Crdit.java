...
public class BankRuleCr_Outofscope_Crdit extends BasePage
{

	
	   HashMap<String, String>hm=new HashMap<String,String>();
		public static String out_OutS_CR="";
		public static String out2_OutS_CR="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Outofscope_Crdit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Outcr"+i+"Cr");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
        ...
        //               
                         ...
                         System.out.println("Save clicekd");
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Outs"+j+"CR");
	...
	public void GetTData() throws InterruptedException
	{
		...
		int Size1=dataa.size();
...

			{
				...
				{
					out_OutS_CR=out_OutS_CR+"~"+dd.getKey();
					out2_OutS_CR=out2_OutS_CR+"~"+dd.getValue();
...
System.out.println("Done ");
	...
	public String out_OutS_CR()
	{
		return out_OutS_CR;
		
	}
	public String out2_OutS_CR()
	{
		return out2_OutS_CR;
