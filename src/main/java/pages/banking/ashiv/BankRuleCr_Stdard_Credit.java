...
public class BankRuleCr_Stdard_Credit extends BasePage
{
    
	HashMap<String, String>hm=new HashMap<String,String>();
	public static String out_Std_CR="";
	public static String out2_Std_CR="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Stdard_Credit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("StC"+i+"Cr");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    ...
    public void ASEnterRuleData() throws Exception
    {
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("SR"+j+"CR");
        	...
        	public void GetTData() throws InterruptedException
        	{
        		...
        		int Size1=dataa.size();
...

        			{
        				...
        				{
        					out_Std_CR=out_Std_CR+"~"+dd.getKey();
        					out2_Std_CR=out2_Std_CR+"~"+dd.getValue();
        ...
        System.out.println("Done ");
        	...
        	public String out_Std_CR()
        	{
        		return out_Std_CR;
        		
        	}
        	public String out2_Std_CR()
        	{
        		return out2_Std_CR;
