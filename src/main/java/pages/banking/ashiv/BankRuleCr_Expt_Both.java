...
public class BankRuleCr_Expt_Both extends BasePage
{
	...
	String Sheet =null;
 	...
 	public static String out_Expt_Both="";
   	public static String out2_Expt_Both="";
   ...
   public void AssertUrl()
	 ...
	 * @throws Exception 
     */
    public void enterFrsmedata() throws InterruptedException, Exception
    {
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("BX"+i+"both");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    ...
    public void ASEnterRuleData() throws Exception
    {
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Exempt"+j+"Both");
    		...
    		List <WebElement> Pages=m_Driver.findElements(By.xpath("//*[@id='ctl00_divSubContent']/div[6]/div/ul/li"));
       		...
       		int Size1=dataa.size();
...

       			{
       				...
       				{
       				out_Expt_Both=out_Expt_Both+"~"+dd.getKey();
       				out2_Expt_Both=out2_Expt_Both+"~"+dd.getValue();
       ...
       System.out.println("Done ");
       	...
       	public String out_Expt_Both()
       	{
       		return out_Expt_Both;
       		
       	}
       	public String out2_Expt_Both()
       	{
       		return out2_Expt_Both;
