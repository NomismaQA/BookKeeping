...
public class BankRuleCr_Expt_Crdit extends BasePage
{

	
	HashMap<String, String>hm=new HashMap<String,String>();
	public static String Out_Expt_Cr="";
	public static String Out2_Expt_Cr="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Expt_Crdit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Exp"+i+"CR");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
        ...
        //               
                         ...
                         System.out.println("Expt Credit");
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Expt"+j+"CR");
	...
	public void GetTData() throws InterruptedException
	{
		...
		int Size1=dataa.size();
...

			{
				...
				{
					Out_Expt_Cr=Out_Expt_Cr+"~"+dd.getKey();
					Out2_Expt_Cr=Out2_Expt_Cr+"~"+dd.getValue();
...
System.out.println("Done ");
	...
	public String Out_Expt_Cr()
	{
		return Out_Expt_Cr;
		
	}
	public String Out2_Expt_Cr()
	{
		return Out2_Expt_Cr;
