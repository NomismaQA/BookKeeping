...
public class BankRuleCr_NoVat_Both extends BasePage
{
    
HashMap<String, String>hm=new HashMap<String,String>();
public static String out_NoVat_Both="";
public static String out2_NoVat_Both="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_NoVat_Both (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("nvat"+i+"both");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("NoVAT"+j+"Both");
           	...
           	public void GetTData() throws InterruptedException
           	{
           		...
           		int Size1=dataa.size();
...

           			{
           				...
           				{
           					out_NoVat_Both=out_NoVat_Both+"~"+dd.getKey();
           				out2_NoVat_Both=out2_NoVat_Both+"~"+dd.getValue();
           ...
           System.out.println("Done ");
           	...
           	public String out_NoVat_Both()
           	{
           		return out_NoVat_Both;
           		
           	}
           	public String out2_NoVat_Both()
           	{
           		return out2_NoVat_Both;
