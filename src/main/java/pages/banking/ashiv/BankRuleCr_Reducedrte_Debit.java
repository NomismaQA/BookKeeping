...
public class BankRuleCr_Reducedrte_Debit extends BasePage
{

	 HashMap<String, String>hm=new HashMap<String,String>();
		public static String out_RR_Dr="";
	  	public static String out2_RR_Dr="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Reducedrte_Debit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Rd"+i+"DR");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
        ...
        //               
                         ...
                         dropdown2.selectByVisibleText("Debit(Receipts)");
                         
                         System.out.println("Debit(Receipts)");
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("RR"+j+"Dr");
                   ...
                   System.out.println("Reduced Rate");
		...
		List <WebElement> Pages=m_Driver.findElements(By.xpath("//*[@id='ctl00_divSubContent']/div[6]/div/ul/li"));
    		...
    		int Size1=dataa.size();
...

    			{
    				...
    				{
    					out_RR_Dr=out_RR_Dr+"~"+dd.getKey();
    					out2_RR_Dr=out2_RR_Dr+"~"+dd.getValue();
    ...
    System.out.println("Done ");
    	...
    	public String out_RR_Dr()
    	{
    		return out_RR_Dr;
    		
    	}
    	public String out2_RR_Dr()
    	{
    		return out2_RR_Dr;
