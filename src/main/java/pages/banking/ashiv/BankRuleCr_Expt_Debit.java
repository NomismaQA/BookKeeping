...
public class BankRuleCr_Expt_Debit extends BasePage
{

	 HashMap<String, String>hm=new HashMap<String,String>();
	public static String out_Expt_Dr="";
  	public static String out2_Expt_Dr="";
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_Expt_Debit (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Ext"+i+"Dbr");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
        ...
        //               
               	...
               	for(int j=1; j<=iRowNum; j++)
               	{
               	    ...
               	    if(j!=0)
                       {
                           ...
                           jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
                       	   ...
                       	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("Exempt"+j+"Dr");
            	...
            	public void GetTData() throws InterruptedException
               	{
               		...
               		int Size1=dataa.size();
...

               			{
               				...
               				{
               					out_Expt_Dr=out_Expt_Dr+"~"+dd.getKey();
               					out2_Expt_Dr=out2_Expt_Dr+"~"+dd.getValue();
               ...
               System.out.println("Done ");
               	...
               	public String out_Expt_Dr()
               	{
               		return out_Expt_Dr;
               		
               	}
               	public String out2_Expt_Dr()
               	{
               		return out2_Expt_Dr;
