...
public class BankRuleCr_ReducedRte_Both extends BasePage
{

	
    HashMap<String, String>hm=new HashMap<String,String>();
   	public static String out_RR_Both="";
   	public static String out2_RR_Both="";
   	
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_ReducedRte_Both (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("RD"+i+"Both");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
           	...
           	public void GetTData() throws InterruptedException
           	{
           		...
           		int Size1=dataa.size();
...

           			{
           				...
           				out2_RR_Both=out2_RR_Both+"~"+dd.getValue();
