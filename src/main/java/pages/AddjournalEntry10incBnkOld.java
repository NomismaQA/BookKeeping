...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/35c25301-c275-453f-8ba5-2f511ca979b7
 ...
 public class AddjournalEntry10incBnkOld extends BasePage
{
	 SeleniumLib sl;
	 double d1 ;
	 double d2 ;
     ...
     int i1 ;
 	 ...
 	 double total1;
 	double total2;
	public AddjournalEntry10incBnkOld (WebDriver driver)
	{		super(driver);
	...
	private By Account3Elem = By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl02_AccountUC1_txtAccount']");
	...
	private By Account4Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl03_AccountUC1_txtAccount\"]");
	...
	private By Account5Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl04_AccountUC1_txtAccount\"]");
	...
	private By Account6Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl05_AccountUC1_txtAccount\"]");
	...
	private By Account7Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl06_AccountUC1_txtAccount\"]");
	...
	private By Account8Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl07_AccountUC1_txtAccount\"]");
	...
	private By Account9Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl08_AccountUC1_txtAccount\"]");
	...
	private By Account10Elem = By.xpath("//*[@id=\"ctl00_cPH_rptRecord_ctl09_AccountUC1_txtAccount\"]");
	...
	private By entry3xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl02_AccountUC1_txtAccount']");
	private By entry4xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl03_AccountUC1_txtAccount']");
	private By entry5xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl04_AccountUC1_txtAccount']");
	private By entry6xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl05_AccountUC1_txtAccount']");
	private By entry7xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl06_AccountUC1_txtAccount']");
	private By entry8xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl07_AccountUC1_txtAccount']");
	private By entry9xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl08_AccountUC1_txtAccount']");
	private By entry10xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl09_AccountUC1_txtAccount']");
	private By entry11xpath=By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl10_AccountUC1_txtAccount']");
...
//		elem.click();
//		
//		String[] splited_ledger = Account2.split("");
//		for (String string : splited_ledger) {
//			String Robot_cmd = "VK_" + string;
//
//            Class<KeyEvent> clazz = KeyEvent.class;
...
// 	   Reporter.log("Ledger 1 Entered :"+LedgerEntered_1, true); 
 	   	elem.click();
		m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Account2);
		
		WebElement ele2=m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input"));
		ele2.sendKeys(Keys.ENTER);
 	   
 		//WebElement ele2=getWebElement(entry2xpath);
 		LedgerEntered_2=Account2;
		expected_entry.add(1, LedgerEntered_2);
  ...
  //  	wt.explicitiWait_presenceOfElementLocated(m_Driver, 20, By.xpath("//li[@class='select2-results__option'][starts-with(text(), '"+Account2+"')]"));
    	//li[@class="select2-results__option"][starts-with(text(), '1070 - Good')]
	 ...
	 //    WebElement elemc= m_Driver.findElement(By.xpath("//li[@class='select2-results__option'][starts-with(text(), '"+Account2+"')]"));
	 //   elemc.click();
 ...
 //	
	...
	TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Account3", "Enter_Account3 failed. Unable to locate object: " + Account3Elem.toString());
       ...
       m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Account3);
...
//		elemc.click();
 	...
 	//	WebElement ele1=getWebElement(entry3xpath);
 		LedgerEntered_3=Account3;
 		expected_entry.add(2,LedgerEntered_3 );
	...
	TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Account4", "Enter_Account4 failed. Unable to locate object: " + Account4Elem.toString());
		...
		elem.click();
		//Thread.sleep(1000);
		//ul[@id="select2-ctl00_cPH_rptRecord_ctl00_ltAccount-results"]/li/ul/li[starts-with(text(), '"+Account4+" -"+"')]
		wt.explicitiWait_presenceOfElementLocated(m_Driver, 20, By.xpath("//ul[@id='select2-ctl00_cPH_rptRecord_ctl00_ltAccount-results']/li/ul/li[starts-with(text(), '"+Account4+" - "+"')]"));
...
System.out.println(variableName);
		...
		*/
		//SeleniumLib sl= new SeleniumLib(m_Driver);
 		...
 		LedgerEntered_8=ele1.getAttribute("value");
 		expected_entry.add(7, ele1.getAttribute("value"));
 	   //System.out.println(LedgerEntered_8);
...
//elem.sendKeys(Keys.BACK_SPACE);
         //Thread.sleep(4000);
        //m_Driver.findElement(By.xpath("//ul[@id='ctl00_cPH_rptRecord_ctl08_AccountUC1_AutoCompleteExtender1_completionListElem']/li[starts-with(text(), '+Account1+')]")).click();
        //Thread.sleep(2000);
		...
		//SeleniumLib sl= new SeleniumLib(m_Driver);
 		...
 		LedgerEntered_9=ele1.getAttribute("value");
 		expected_entry.add(8, ele1.getAttribute("value"));
 	    //System.out.println(LedgerEntered_9);
	...
	TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Account10", "Enter_Account10 failed. Unable to locate object: " + Account10Elem.toString());
		...
		//SeleniumLib sl= new SeleniumLib(m_Driver);
 		...
 		LedgerEntered_10=ele1.getAttribute("value");
 		expected_entry.add(9, ele1.getAttribute("value"));
 	    //System.out.println(LedgerEntered_10);
