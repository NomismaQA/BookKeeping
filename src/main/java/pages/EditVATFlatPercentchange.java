...
public class EditVATFlatPercentchange extends BasePage
{
	public EditVATFlatPercentchange (WebDriver driver)
	{
		super(driver);
	}
...
elem.click();
     ...
     */
 	public void Enter_OverrideFLATRate(String OverrideFLATRate) throws InterruptedException
 	{
