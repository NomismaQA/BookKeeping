...
import pages.banking.ashiv.waitutility;
...
public class BasePage {
    protected static WebDriver m_Driver;
    ...
    public static void Sendkey(WebElement ele,String text)
    {
    	waitutility.VisibiltyElement(10, ele);
    	ele.sendKeys(text);
    }
}
