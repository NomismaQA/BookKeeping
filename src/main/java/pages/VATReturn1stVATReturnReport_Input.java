...
public class VATReturn1stVATReturnReport_Input extends BasePage
{
	public VATReturn1stVATReturnReport_Input (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_VATReturnsTAB() throws InterruptedException, HeadlessException, IOException, AWTException
	{
		...
		Thread.sleep(1000);
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPHFilter_ddlVATTypeCategory']")).click();
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPHFilter_ddlVATTypeCategory']")).sendKeys(Keys.ARROW_DOWN);
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPHFilter_ddlVATTypeCategory']")).sendKeys(Keys.ENTER);
