...
public class PartialReconcilationLAtestForCreditnote extends BasePage
{
	public String Rpno=" ";
	String InvoiceNo=" ";
	int tot=0;
	public PartialReconcilationLAtestForCreditnote (WebDriver driver)
	{
		super(driver);
	}
...
//		  
	   ...
	   //      int rowcount = m_Driver.findElements(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[3]/div/div/div/table/tbody/tr[2]/td/div[2]/table/tbody/tr[1]/td/div/table/tbody/tr")).size();
		   ...
		   for(int i=1;i<=rowcount;i++)
		   {
		    	...
		    	//	WebElement m = m_Driver.findElement(By.xpath("/html/body/form/main/div[5]/div[3]/div/div[2]/table/tbody/tr["+i+"]/td[6]"));
...
////*[@id="ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl02_cbSelect"]
	...
	public void Click_ReconcileLink() throws IOException
	{
		...
		elem.click();
          	GetScreenShot.captureAsImage(m_Driver,"reconcilecredit");
