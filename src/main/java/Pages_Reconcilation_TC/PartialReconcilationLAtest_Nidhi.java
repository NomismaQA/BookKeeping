...
public class PartialReconcilationLAtest_Nidhi extends BasePage
{
	String Rpno=" ";
	public PartialReconcilationLAtest_Nidhi (WebDriver driver)
	{
		super(driver);
	}
...
////*[@id="ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl02_cbSelect"]
     ...
     */
	public void Click_ReconcileLink() throws HeadlessException, IOException, AWTException
	{
        String str = Rpno;
