...
//		//*[@id="ctl00_cPH_rvReport_ctl10_ctl05_ctl00_ctl00_ctl00"]
	...
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Advance Reconcile of Invoice With Bank pdf and preview", "Reconcile");
	}
	public void ScreenshotJou() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Advance Reconcile of Invoice With jouranl Entry pdf and preview", "Reconcile");
	}
	
	public void Screenshot1() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("full reconililation of Credit Note With Bank Pdf and preview", "Reconcile");
	}
	public void Screenshot2() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Credit Note Advance Reconcile With JournalEntry Pdf And preview", "Reconcile");
	}
	public void ScreenshotCreditnoteWithbank() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Credit Note Advance reconililation With Bank Pdf and  preview", "Reconcile");
	}
	public void Screenshot3() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Credit Note Partial Reconcile With Journal Entry Pdf and preview", "Reconcile");
	}
	public void Screenshot4() throws InterruptedException
	{
		Thread.sleep(3000);
		utilities.Screenshotcapture.Getscreenshot("Credit Note Partial Reconcile With Bank Pdf and preview", "Reconcile");
	}
	public void Click_SaveButtonCreditNote() throws InterruptedException, HeadlessException, IOException, AWTException
	{
