...
public class nBANKTRN_DebitNote extends BasePage
{
     public static String krno1;
     public static String savemassg;
     
	public nBANKTRN_DebitNote (WebDriver driver)
	{
		super(driver);
	}
...
//		elem.click();
		...
		Supplier_pages.DebitNoteSToFRS re= new Supplier_pages.DebitNoteSToFRS(m_Driver);
