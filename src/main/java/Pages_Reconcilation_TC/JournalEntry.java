...
public class JournalEntry extends BasePage
{
	...
	private By AccountantlefttabElem = By.xpath("//*[@id='ctl00_SideMenu1_accountantMenu']/a/span");
...
// 		
     ...
     */
 	...
 	m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Clickaccountbox);
...
Thread.sleep(1000);
	...
	public void Enter_Clickaccountbox2(String Clickaccountbox) throws InterruptedException
 	{
 	...
 	m_Driver.findElement(By.xpath("//*[@id='select2-ctl00_cPH_rptRecord_ctl01_ltAccount-container']")).click();
 	m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Clickaccountbox);
	m_Driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Keys.ENTER);
...
Thread.sleep(1000);
     ...
     */
 	...
 	public void Enter_Credit2(String Amount)
 	{
 		m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id='ctl00_cPH_journalmodal1Iframe1']")));
 		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl01_txtCredit']")).sendKeys(Amount);
 		m_Driver.switchTo().defaultContent();
 	}
	public void Enter_Debit2(String Amount)
 	{
		m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id='ctl00_cPH_journalmodal1Iframe1']")));
 		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl01_txtDebit']")).sendKeys(Amount);
 		m_Driver.switchTo().defaultContent();
 	}
	public void Enter_Note2(String Note)
	{
		m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id='ctl00_cPH_journalmodal1Iframe1']")));
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl01_txtNote']")).sendKeys(Note);
		m_Driver.switchTo().defaultContent();
	}
