...
public class VATOnlyBillSToFRS extends BasePage
{
	...
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/AccountUI/SupplierVATOnlyEditor.aspx?FYCode=52552&CompanyCode=13326&id=0&action=Add");

		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL", "Go to URL - http://sandbox4.nomismasolution.co.uk/AccountUI/SupplierVATOnlyEditor.aspx?FYCode=52552&CompanyCode=13326&id=0&action=Add");
		
		TestModellerLogger.PassStepWithScreenshot(m_Driver, "Go to URL", "Go to URL - http://sandbox4.nomismasolution.co.uk/AccountUI/SupplierVATOnlyEditor.aspx?FYCode=52552&CompanyCode=13326&id=0&action=Add");
	}
   ...
   public void AssertUrl()
    {
        ...
        String expectedUrl = "http://sandbox4.nomismasolution.co.uk/AccountUI/SupplierVATOnlyEditor.aspx?FYCode=52552&CompanyCode=13326&id=0&action=Add";
	...
	public void Click_VATOnlyBill()
	{
		...
		elem.click();
          	System.out.println("Click_VATOnlyBill");
     ...
     */
 	public void Enter_InvoiceNo(String InvoiceNo)
 	{
 		...
 		System.out.println("Enter_InvoiceNo = "+InvoiceNo);
     ...
     */
 	public void Enter_InvoiceDate(String InvoiceDate)
 	{
 		...
 		System.out.println("Enter_InvoiceDate");
     ...
     */
 	public void Enter_SubTotal(String SubTotal)
 	{
 		...
 		System.out.println("Enter_SubTotal = "+SubTotal);
	...
	public void Recell_Last_Entry()
	{
		
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_btnRecall']")).click();
		System.out.println("Click Recell_Last_Entry");
	}
	
	public void Click_CancelBtn() throws InterruptedException
	{
		m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_btnCancel']")).click();
		Thread.sleep(2000);
		System.out.println("Click_CancelBtn");
		utilities.Screenshotcapture.Getscreenshot("After CancelBtn Previous Page.", "VAT Bill Only");
	}
