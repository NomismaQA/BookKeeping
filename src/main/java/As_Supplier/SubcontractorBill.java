...
public class SubcontractorBill extends BasePage
{
	...
	private By SupplierElem = By.xpath("//select[@id='ctl00_cPH_ddlSupplier']");

	private By DateElem = By.xpath("//*[@id='ctl00_cPH_txtDate']");

	private By DueDateElem = By.xpath("//label[contains(.,'Due Date:')]/../div/div/input");

	private By ExpenseTypeElem = By.xpath("//select[@id='ctl00_cPH_rptrProduct_ctl00_ddExpenseHead']");
	...
	private By SelectVATRateElem = By.xpath("//select[@id='ctl00_cPH_rptrProduct_ctl00_ddVATRate']");
...
System.out.println("Click_ExpenditueTAB");
    ...
    public void Select_ExpenseType(String ExpenseType)
 	{
        ...
        String ExpType=elem.getText();
        
        System.out.println("ExpType List "+ExpType);
    ...
    public void Select_SelectVATRate(String SelectVATRate)
 	{
 		...
 		System.out.println("Vat Type List"+VatType);
	...
	public void Click_SaveButton()
	{
		...
		utilities.Screenshotcapture.Getscreenshot("Fill From After SaveBtn", "SubContractor");
	...
	public void ClickCancelBtn()
	{
		...
		utilities.Screenshotcapture.Getscreenshot("After CancelBtn", "SubContractor");
	}
}