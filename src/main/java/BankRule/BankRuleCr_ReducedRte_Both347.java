...
public class BankRuleCr_ReducedRte_Both347 extends BasePage
{

	
    HashMap<String, String>hm=new HashMap<String,String>();
   	public static String out_RR_Both="";
   	public static String out2_RR_Both2="";
   	
	List<WebElement> data1;
	int i,size;
	public BankRuleCr_ReducedRte_Both347 (WebDriver driver)
	{
		super(driver);
	}
...
//                           
        ...
        //                                         
                    m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("RR"+i+"Both");
        //            
                            m_Driver.findElement(By.xpath("//*[contains(text(),'VATRateType')]")).click();
        //                
    	...
    	for(int j=1; j<=iRowNum; j++)
    	{
    	    ...
    	    if(j!=0)
            {
                ...
                jsExec.executeScript("arguments[0].click();", m_Driver.findElement(By.xpath("//A[@id='ctl00_cpHeaderRight_btnAdd']")));
            	   ...
            	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrParam_ctl00_txtParamValue']")).sendKeys("RR"+j+"Both");
           	...
           	public void GetTData() throws InterruptedException
           	{
           		...
           		int Size1=dataa.size();
...

           			{
           				...
           				{
           				out_RR_Both=out_RR_Both+"~"+dd.getKey();
           				out2_RR_Both2=out2_RR_Both2+"~"+dd.getValue();
           ...
           System.out.println("Done ");
           	...
           	public String out_RR_Both()
           	{
           		return out_RR_Both;
           		
           	}
           	public String out2_RR_Both2()
           	{
           		return out2_RR_Both2;
