...
public class SaleInToReconcile_Nidhi_DefaultProfile extends TestBase
{
...
//    _nlogin.AssertUrl();
    ...
    _nlogin.Enter_nPASS("sandbox@nom");
...
//    _SaleInvoice.AssertUrl();
    ...
    _SaleInvoice.Select_CustomerName("Nidhis");
...
pages.PartialReconciledCases.ForSearching _src = new pages.PartialReconciledCases.ForSearching(driver);
...
//    
    ...
    TestModellerLogger.SetLastNodeGuid(data[9]);
