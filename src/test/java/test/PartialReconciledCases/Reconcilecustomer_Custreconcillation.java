...
public class Reconcilecustomer_Custreconcillation extends TestBase
{
    ...
    public void CustreconcillationGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAss1() throws InterruptedException, InvalidFormatException
    {
    	sTestCaseID="TC1";
