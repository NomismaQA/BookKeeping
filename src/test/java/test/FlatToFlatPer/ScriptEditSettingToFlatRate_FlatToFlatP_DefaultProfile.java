...
public class ScriptEditSettingToFlatRate_FlatToFlatP_DefaultProfile extends TestBase
{
...
//    _EditSettingToStandard.AssertUrl();
    ...
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButtonGoToUrlAssertUrlCl2() throws InterruptedException, InvalidFormatException, IOException, AWTException
    {
    	sTestCaseID="TC105";
    	Sheet="Sale_NewInvoice";
    	data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
