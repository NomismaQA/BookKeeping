...
public class tr_new_bank extends TestBase
{
...
//    _nlogin.AssertUrl();
  ...
  _BK.Banktrans();
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlCl2() throws InvalidFormatException, InterruptedException, EncryptedDocumentException, IOException
    {
...
pages.bankmenu _bankmenu = new pages.bankmenu(driver);
  ...
  TestModellerLogger.SetLastNodeGuid("cd431e1c-5f14-4042-85e6-c92307a9ba2b");
   ...
   pages.BankRule.BANKTRN_New _BK=new pages.BankRule.BANKTRN_New(driver);
  _BK.Banktrans();
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlCl4() throws InvalidFormatException, InterruptedException, EncryptedDocumentException, IOException
    {
