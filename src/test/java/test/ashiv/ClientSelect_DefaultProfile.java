...
public class ClientSelect_DefaultProfile extends TestBase
{
    ...
    public void GoToUrlAssertUrlClickClientsTABPositiveEnterClientNameClickSearchButtonClickSelectClient() throws InterruptedException, InvalidFormatException
    {
    	 sTestCaseID="TC7"; 
   	  Sheet="BankingBank"; 
    ...
    _ClientSelect.Enter_ClientName(data[3]);
