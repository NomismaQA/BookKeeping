...
public class Rule3_rule3_347Code extends TestBase
{
...
//	  }
	 ...
	 pages.banking.ashiv.Searchclient _Searchclient = new pages.banking.ashiv.Searchclient(driver);
	  ...
	  TestModellerLogger.SetLastNodeGuid("a71cb6de-7787-4e86-ac83-a09ab1ce3b13");
	  _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany(data[5]);
	 ...
	 pages.banking.ashiv.bankmenu _bankmenu = new pages.banking.ashiv.bankmenu(driver);
	  ...
	  BankRule.BankRuleCr_ReducedRte_Both347 _rulecreate2=new BankRule.BankRuleCr_ReducedRte_Both347(driver);
//	 
//	  
  _rulecreate2.enterFrsmedata();
	  ...
	  _ob.Fill_Recnl_Bank_RR_Both347();
