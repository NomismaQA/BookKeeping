...
public class TC04DeleteInvoide extends TestBase
{
...
//    	    TestModellerLogger.SetLastNodeGuid("9b4a89f1-4dd6-4c9d-a653-42321721ed34");
    	   // _Searchclient.AssertUrl();
    	    ...
    	    SalesThreedot.Click_DeleteIcon();
    	    
    	    SalesThreedot.Click_GetHeader();
    	    
    	    SalesThreedot.Click__Delete_();
