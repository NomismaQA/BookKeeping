...
public class TestOtherInvoiceTemplate_EmailFunctionality_TC02 extends TestBase
{
    ...
    public void GoToUrlAssertUrlPositiveSelectSelectInvoicePositiveSelectEmailTemplateCheakAllEmailFunctionalityOtherInvoiceTemp_TC02() throws HeadlessException, IOException, AWTException, InterruptedException, InvalidFormatException
    {
    	sTestCaseID="TC02_OtherInvoiceTemplate";
    	Sheet="Fin-3821";
...
//	    Thread.sleep(15000);
       ...
       //  _MailPlus.SelectTemplate();
		...
		_MailPlus.SendEmail3("muhammad.ashiv@nomisma.co.uk");
