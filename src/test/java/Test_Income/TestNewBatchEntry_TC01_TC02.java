...
public class TestNewBatchEntry_TC01_TC02 extends TestBase
{
    ...
    public void ClickNew1ClickNewBatchEntry2PositiveEnterInvoiceDate3PositiveSelectSelectCustomer4PositiveCustomerList_SeleteCustomer_TC01_TC02() throws InvalidFormatException, InterruptedException, HeadlessException, IOException, AWTException
    {
...
//          _SaleCreditNote.AssertUrl();
    ...
    utilities.Screenshotcapture.Getscreenshot("Invoice should be book in selected customer", "New Batch Entry");
