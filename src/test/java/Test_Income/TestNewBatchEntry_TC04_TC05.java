...
public class TestNewBatchEntry_TC04_TC05 extends TestBase
{
    ...
    public void ClickNew1ClickNewBatchEntry2PositiveEnterInvoiceDate3PositiveSelectSelectCustomer4PositiveSelecWithoutFillEntryClickSaveBtnMsgPopup_TC04_TC05 () throws InvalidFormatException, InterruptedException, HeadlessException, IOException, AWTException
    {
...
//          _SaleCreditNote.AssertUrl();
 ...
 //   _New_Batch_entry.Enter_Enter_Description_8("Ashiv");
   ...
   // _New_Batch_entry.Click_Save_Add_More_11();
    ...
    utilities.Screenshotcapture.Getscreenshot("Click Save  Without Fill Entry Msg ", "New Batch Entry");
