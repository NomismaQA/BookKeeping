...
public class Test_VATOnlyInvoice extends TestBase
{
    ...
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButtonGoToUrlAssertUrlCl1_TC01() throws InterruptedException, InvalidFormatException, HeadlessException, IOException, AWTException
    {
    	sTestCaseID="TC14";
    	 	Sheet="Fin-3821";
...
//    _VATOnlyInvoice.AssertUrl();
    ...
    _VATOnlyInvoice.NewCreateCustomer("Ashiv1");
    
    _VATOnlyInvoice.allcustomer();

    TestModellerLogger.SetLastNodeGuid("af5213eb-5d8a-417b-a6c7-f9001ab08632");
    _VATOnlyInvoice.Select_CustomerName("Ashiv1");
    
    _VATOnlyInvoice.SelectCustomer();
...
//    _VATOnlyInvoice.Enter_ConvertedAmount("100");
 ...
 //   TestModellerLogger.SetLastNodeGuid("a2bdfe37-c194-4ea0-b657-4d576468655c");
  //  _VATOnlyInvoice.Click_SaveButton();
    ...
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButtonGoToUrlAssertUrl_TC02() throws InterruptedException, InvalidFormatException, HeadlessException, IOException, AWTException
    {
...
//    
    ...
    @Test  (groups= {"ScriptVATOnlyInvoice","ScriptVATOnlyInvoice - Default Profile"})
    @TestModellerPath(guid = "d40062cd-e960-458c-a525-9f4b0e3ec85d")
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButtonGoToUrlAssertUrl_TC03() throws InterruptedException, InvalidFormatException, HeadlessException, IOException, AWTException
    {
...
//    _VATOnlyInvoice.AssertUrl();
   ...
   // _VATOnlyInvoice.AllvatScreenshot();
...
//    
 ...
 //   _VATOnlyInvoice.Click_SaveButton();
    ...
    @Test  (groups= {"ScriptVATOnlyInvoice","ScriptVATOnlyInvoice - Default Profile"})
    @TestModellerPath(guid = "d40062cd-e960-458c-a525-9f4b0e3ec85d")
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButtonGoToUrlAssertUrl_TC04() throws InterruptedException, InvalidFormatException, HeadlessException, IOException, AWTException
    {
...
//    _VATOnlyInvoice.AssertUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("fb8ddf53-f049-479e-bc7f-7616b0c519b3");
    _VATOnlyInvoice.Enter_InvoiceNo("Recall");
