...
public class TestSimpleInvoiceTemplate_RecallLast_TC02 extends TestBase
{
    ...
    public void GoToUrlLoginApplicationWithValidCredentialsClickNewClickCreateInvoiceRecallTheLastChangeInvoiceNo_TC2() throws InvalidFormatException, InterruptedException, HeadlessException, IOException, AWTException
    {
   	 sTestCaseID="TC02_SimpleInvoiceTemplate";
     Sheet="Fin-3821";
