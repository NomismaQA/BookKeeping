...
public class TestOtherInvoiceTemplate_SelectTemplate_TC01 extends TestBase
{
    ...
    public void GoToUrlLoginApplicationWithValidCredentialsClickNewClickCreateInvoiceCreateNewInvoiceVerifyNewInvoiceAddedSuccessfullyChoseOtherTemplateOtherInvoiceTemp_TC01() throws InvalidFormatException, InterruptedException, HeadlessException, IOException, AWTException
    {
   	 sTestCaseID="TC01_OtherInvoiceTemplate";
     Sheet="Fin-3821";
...
//      _SaleInvoice.AssertUrl();
      ...
      //_SaleInvoice.SelectTempPlate(data[6]);
      _SaleInvoice.SelectTemp(data[6]);
      ...
      //_SaleInvoice.SelectTempPlate(data[6]);
      _SaleInvoice.SelectTemp(data[7]);
...
//      _NewPreviewPage.Click_ClickOnMail();
  ...
  //  _SaleInvoice.GetSuccessText();
      ...
      TestModellerLogger.SetLastNodeGuid("715cfaaf-aba7-40a9-82e6-410e09784e97");
      _NewPreviewPage.Click_ClickOnPreview3();
      

      TestModellerLogger.SetLastNodeGuid("23d6006a-2648-4df5-a3f3-c2e17c157827");
      _NewPreviewPage.Click_SaveButton3();
