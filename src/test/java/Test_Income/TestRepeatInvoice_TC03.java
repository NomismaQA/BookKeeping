...
public class TestRepeatInvoice_TC03 extends TestBase
{
    ...
    public void GoToUrlClickView1ClickRepeatInvoice2ClickAddRepeatInvoice3PositiveSelectSelectCustomer4PosititClickThreeDot1ClickDelete_TC03() throws InterruptedException, InvalidFormatException, HeadlessException, IOException, AWTException
    {
...
//   _Repeat_Invoice_2.Click_Save_2_6();
   ...
   //
   _Repeat_Invoice_2.Screenshot_Del_Page();
   
   TestModellerLogger.SetLastNodeGuid("8b47e0a3-2ec5-4cc5-9752-345b9ed36dd1");
   _Repeat_Invoice_2.deleteBtn();
   //    
       _Repeat_Invoice_2.Screenshot_Del_Page_Suss_Msg();
