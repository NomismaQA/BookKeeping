...
public class TC_24_2_BS_TAXATION_1100_1103_1104_With_Journal_Bank extends TestBase
{
...
//    _pagesDeletejournalEntry1.Click_xPath_htmlbodyformmaindiv10div3headerdiva1i();
    ...
    _pagesAddjournalEntry10incBnk.Enter_Credit3(data[14]);
//    
//
//
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_1100_1102_1104();
    
utilities.Screenshotcapture.FullScreenshot("TC_24_TAXATION_1100-1103-1104_With JournalEntry");
...
//_DebitNoteSToFRS.Select_ExpenseType(data[13]);
//
//
...
//_DebitNoteSToFRS.Enter_UnitPrice(data[14]);
//
//
//
...
//  
//   
//   utilities.Screenshotcapture.FullScreenshot("TC_24_TAXATION_1100-1103-1104_With_Supplier");
//    }
...
//    
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_24_TAXATION_1100-1103-1104_With_Bank");
...
//        @Test  (groups= {"SaleInToReconcile","SaleInToReconcile - Default Profile"})
//        @TestModellerPath(guid = "8c7c840e-6086-4f3d-b9ff-7b3f3724775c")
//        public void GoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlClickAgentsP4()throws Exception
//        {
//        	sTestCaseID="TC_48";
//           	Sheet="TrailBalanceReport_2";
//            data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
//
//      TestModellerLogger.SetLastNodeGuid("73677a32-1892-47f6-9783-a1072478778a");
//      _SaleInvoice.Enter_UnitPrice(data[12]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("d810d5bf-a960-434c-9172-1671dd383495");
//      _SaleInvoice.Enter_Quantity("1");
