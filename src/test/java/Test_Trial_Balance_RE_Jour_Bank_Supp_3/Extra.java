package Test_Trial_Balance_RE_Jour_Bank_Supp_3;
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Debit2(data[12]);
   ...
   // _pagesAddjournalEntry10incBnk.Enter_Debit9("1800");
    ...
    TestModellerLogger.SetLastNodeGuid("77043df3-8ed7-4403-b124-30f3a3606e6b");
    _pagesAddjournalEntry10incBnk.Enter_Account10(data[27]);
   ...
   // _pagesAddjournalEntry10incBnk.Enter_Debit9("1800");
    ...
    TestModellerLogger.SetLastNodeGuid("8244b198-d419-4a83-92ae-fcbf4383fd00");
    _pagesAddjournalEntry10incBnk.Enter_Credit10(data[28]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_FixedAsset_200_209();
    
utilities.Screenshotcapture.FullScreenshot("TC_01_FixedAsset_Report_Ladger Code_10-19_With JournalEntry");
    ...
    pages.PartialReconciledCases.Searchclient _Searchclient = new pages.PartialReconciledCases.Searchclient(driver);
        ...
        Trial_Balance.New_Supplier_Bill_Batch _New_Supplier_Bill_Batch = new Trial_Balance.New_Supplier_Bill_Batch(driver);
    ...
    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        ...
        _New_Supplier_Bill_Batch.ExpenceType(data[9]);
        
     
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
        _New_Supplier_Bill_Batch.Enter_Date1(data[5]);

        
        TestModellerLogger.SetLastNodeGuid("29dd302b-2f78-4f4a-bada-9d003c6cfc4a");
        _New_Supplier_Bill_Batch.Select_Select_Supplier_1(data[6]);
        

        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_1(data[30]);
        

        TestModellerLogger.SetLastNodeGuid("032dd099-ac7a-4797-959b-9f5522973eaf");
        _New_Supplier_Bill_Batch.Enter_Description_1(data[8]);
        

        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_1(data[12]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_1(data[11]);
        
       
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
        _New_Supplier_Bill_Batch.Enter_Date2(data[5]);

        TestModellerLogger.SetLastNodeGuid("29dd302b-2f78-4f4a-bada-9d003c6cfc4a");
        _New_Supplier_Bill_Batch.Select_Select_Supplier_2(data[6]);
        

        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_2(data[31]);
        

        TestModellerLogger.SetLastNodeGuid("032dd099-ac7a-4797-959b-9f5522973eaf");
        _New_Supplier_Bill_Batch.Enter_Description_2(data[8]);
        

        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_2(data[14]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_2(data[13]);
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
        _New_Supplier_Bill_Batch.Enter_Date3(data[5]);

        TestModellerLogger.SetLastNodeGuid("29dd302b-2f78-4f4a-bada-9d003c6cfc4a");
        _New_Supplier_Bill_Batch.Select_Select_Supplier_3(data[6]);
        

        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_3(data[32]);
        

        TestModellerLogger.SetLastNodeGuid("032dd099-ac7a-4797-959b-9f5522973eaf");
        _New_Supplier_Bill_Batch.Enter_Description_3(data[8]);
        

        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_3(data[16]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_3(data[15]);
        
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
        _New_Supplier_Bill_Batch.Enter_Date4(data[5]);

//        TestModellerLogger.SetLastNodeGuid("29dd302b-2f78-4f4a-bada-9d003c6cfc4a");
//        _New_Supplier_Bill_Batch.Select_Select_Supplier_4(data[6]);
//        
//
//        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
//        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_4(data[31]);
//        
//
//        TestModellerLogger.SetLastNodeGuid("032dd099-ac7a-4797-959b-9f5522973eaf");
//        _New_Supplier_Bill_Batch.Enter_Description_4(data[8]);
//        
//
//        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
//        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_4(data[18]);
//        
//
//    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
//      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
//        
//        _New_Supplier_Bill_Batch.ExpenceType_4(data[17]);
        
        
        
        TestModellerLogger.SetLastNodeGuid("a88557d3-8751-4d6c-ae45-76caba6b5868");
        _New_Supplier_Bill_Batch.Click_SaveMoreBtn();
        ...
        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_0(data[33]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_0(data[18]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType(data[17]);
        ...
        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_1(data[34]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_1(data[20]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_1(data[19]);
        ...
        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_2(data[35]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_2(data[22]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_2(data[21]);
        ...
        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_3(data[36]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_3(data[24]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_3(data[23]);
...
//        _New_Supplier_Bill_Batch.ExpenceType_4(data[17]);
        ...
        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_0(data[37]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_0(data[26]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType(data[25]);
        ...
        _New_Supplier_Bill_Batch.Select_Select_Supplier_Bill_Type_1(data[39]);
        

        TestModellerLogger.SetLastNodeGuid("aaeb0de0-e38e-4288-8b58-c3b26a63b5aa");
        _New_Supplier_Bill_Batch.Enter_Enter_Bill_No_1(data[38]);
        ...
        TestModellerLogger.SetLastNodeGuid("b599506c-7a34-438a-bc21-9664c91b9162");
        _New_Supplier_Bill_Batch.Enter_Enter_NetTotal_1(data[28]);
        

    //    TestModellerLogger.SetLastNodeGuid("aa35da43-8007-4d5b-9873-08aac9250d5e");
      //  _New_Supplier_Bill_Batch.Select_Select_VATRate_10(data[10]);
        
        _New_Supplier_Bill_Batch.ExpenceType_1(data[27]);
...
//      _New_Supplier_Bill_Batch.ExpenceType_4(data[17]);
   ...
   //    _New_Supplier_Bill_Batch.verify_BS_FixedAsset_10_19_Supplier();
       
       utilities.Screenshotcapture.FullScreenshot("TC_01_FixedAsset_Report_Ladger Code_10-19_With JournalEntry_Supplier");
}
   ...
   // _nBANKTRN.Select_Select_VATRate("Standard Rate");
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_01_FixedAsset_Report_Ladger Code_10-19_With JournalEntry_Supplier_Bank");
...
//      Trial_Balance.nBANKTRN_3 _nBANKTRN = new Trial_Balance.nBANKTRN_3(driver);
//   
//
//      //TestModellerLogger.SetLastNodeGuid("32c9440758-2f86-4894-829c-0d5b167b4d77");
//     // _nBANKTRN.Select_BK_SELECT(data[5]);
...
//
//      TestModellerLogger.SetLastNodeGuid("0f5a2a25-9705-4e67-8818-b65654218779");
//      _nBANKTRN.Enter_Recived_amt(data[10]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("c690e93b-6b55-451f-b3be-8e8499f0cee5");
//      _nBANKTRN.Enter_spnt_amt(data[40]);
...
//      
//      TestModellerLogger.SetLastNodeGuid("3f2cfb4f-290b-419a-9ed6-4e05cf7a2f84");
//      _nBANKTRN.Enter_NDate1(data[5]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("10e5cab1-05f8-476d-a283-f0a589c153b9");
//      _nBANKTRN.Enter_n_desc1(data[8]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("0f5a2a25-9705-4e67-8818-b65654218779");
//      _nBANKTRN.Enter_Recived_amt1(data[12]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("c690e93b-6b55-451f-b3be-8e8499f0cee5");
//      _nBANKTRN.Enter_spnt_amt1(data[40]);
//      
//
//
//      TestModellerLogger.SetLastNodeGuid("8cb869ce-983f-422b-a7ab-11f2359ec333");
//      _nBANKTRN.Enter_BOX1(data[11]);
//      
//
//        
//  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//      
//      TestModellerLogger.SetLastNodeGuid("3f2cfb4f-290b-419a-9ed6-4e05cf7a2f84");
//      _nBANKTRN.Enter_NDate2(data[5]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("10e5cab1-05f8-476d-a283-f0a589c153b9");
//      _nBANKTRN.Enter_n_desc2(data[8]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("0f5a2a25-9705-4e67-8818-b65654218779");
//      _nBANKTRN.Enter_Recived_amt2(data[14]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("c690e93b-6b55-451f-b3be-8e8499f0cee5");
//      _nBANKTRN.Enter_spnt_amt2(data[40]);
//      
//
//
//      TestModellerLogger.SetLastNodeGuid("8cb869ce-983f-422b-a7ab-11f2359ec333");
...
//      
//      TestModellerLogger.SetLastNodeGuid("3f2cfb4f-290b-419a-9ed6-4e05cf7a2f84");
//      _nBANKTRN.Enter_NDate3(data[5]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("10e5cab1-05f8-476d-a283-f0a589c153b9");
//      _nBANKTRN.Enter_n_desc3(data[8]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("0f5a2a25-9705-4e67-8818-b65654218779");
//      _nBANKTRN.Enter_Recived_amt3(data[16]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("c690e93b-6b55-451f-b3be-8e8499f0cee5");
//      _nBANKTRN.Enter_spnt_amt3(data[40]);
//      
//
//
//      TestModellerLogger.SetLastNodeGuid("8cb869ce-983f-422b-a7ab-11f2359ec333");
//      _nBANKTRN.Enter_BOX3(data[15]);
//      
//
//
//      TestModellerLogger.SetLastNodeGuid("392f9d4d-b082-42d6-8f76-9054b29928ae");
