...
public class TC_15_3_BS_FixedAsset_630_To_639_With_Journal_Bank_Supplier extends TestBase
{
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_FixedAsset_630_639();
    
utilities.Screenshotcapture.FullScreenshot("TC_15_FixedAsset_Report_Ladger Code_630-639_With JournalEntry");
...
//    _bankmenu.Click_Newmenu();
   ...
   // _nBANKTRN.Select_Select_VATRate("Standard Rate");
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_15_FixedAsset_Report_Ladger Code_630-639_With JournalEntry_Supplier_Bank");
