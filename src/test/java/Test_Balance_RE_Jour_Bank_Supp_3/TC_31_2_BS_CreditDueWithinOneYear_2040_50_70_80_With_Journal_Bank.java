...
public class TC_31_2_BS_CreditDueWithinOneYear_2040_50_70_80_With_Journal_Bank extends TestBase
{
...
//
    ...
    _pagesAddjournalEntry10incBnk.Enter_Credit4(data[16]);
//    
//
//   
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_BF_CreditorDueWithinYear_2040_2080();
    
utilities.Screenshotcapture.FullScreenshot("TC_31_CreditDueWithinOneYear_2040-2050-2070-2080_With JournalEntry");
...
//    
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_31_CreditDueWithinOneYear_2040-2050-2070-2080_With JournalEntry_Bank");
