...
public class TC_42_2_BS_CurrentAsset_1410_11_50_With_Journal_Bank extends TestBase
{
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_2400_2406();
    
utilities.Screenshotcapture.FullScreenshot("TC_42_CURRENT_ASSET_1410-1411-1450_With JournalEntry");
...
utilities.Screenshotcapture.FullScreenshot("TC_42_CURRENT_ASSET_1410-1411-1450_With JournalEntry_Bank");
