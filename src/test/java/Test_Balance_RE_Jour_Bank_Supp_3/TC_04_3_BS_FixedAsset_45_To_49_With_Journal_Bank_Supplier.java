...
public class TC_04_3_BS_FixedAsset_45_To_49_With_Journal_Bank_Supplier extends TestBase
{
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account2(data[27]);
    

    TestModellerLogger.SetLastNodeGuid("7d4b5d8c-b9a4-4fd9-99b2-f6024b3fadda");
    _pagesAddjournalEntry10incBnk.Enter_Credit2(data[28]);
...
//    
//    TestModellerLogger.SetLastNodeGuid("77043df3-8ed7-4403-b124-30f3a3606e6b");
//    _pagesAddjournalEntry10incBnk.Enter_Account7(data[27]);
//    
//
//    //TestModellerLogger.SetLastNodeGuid("a28d1f7d-d811-4d4e-a3d8-db36de973a9b");
//   // _pagesAddjournalEntry10incBnk.Enter_Debit9("1800");
...
//
//    TestModellerLogger.SetLastNodeGuid("8244b198-d419-4a83-92ae-fcbf4383fd00");
//    _pagesAddjournalEntry10incBnk.Enter_Credit7(data[28]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
   ...
   // _pagesverifyBS.Select_selectFinancialYear(data[26]);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_FixedAsset_40_49_2();
    
utilities.Screenshotcapture.FullScreenshot("TC_04_FixedAsset_Report_Ladger Code_45-49_With JournalEntry");
...
//
//      TestModellerLogger.SetLastNodeGuid("7ea52093-1dd7-4979-8034-aeaef336d945");
//      _SupplierBillSToFRS.Select_ExpenseType(data[27]);
//      
//
//      TestModellerLogger.SetLastNodeGuid("de8f87b1-ff3a-421c-9290-6ddaef339bf2");
//      _SupplierBillSToFRS.Enter_Description(data[8]);
...
//
//      TestModellerLogger.SetLastNodeGuid("31e40f93-4cb6-45b2-bb91-cdd42e0f2f68");
//      _SupplierBillSToFRS.Enter_UnitPrice(data[28]);
//      
//
//   
//
...
//      
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    _DebitNoteSToFRS.Click__Save_();
       ...
       utilities.Screenshotcapture.FullScreenshot("TC_04_FixedAsset_Report_Ladger Code_45-49_With JournalEntry_Supplier");
}
...
//    
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_04_FixedAsset_Report_Ladger Code_45-49_With JournalEntry_Supplier_Bank");
