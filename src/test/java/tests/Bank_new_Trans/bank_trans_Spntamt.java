...
public class bank_trans_Spntamt extends TestBase
{
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlCl1() throws Exception
    {
    	sTestCaseID="TC5";
    	Sheet="51ledgercode";
...
//    TestModellerLogger.SetLastNodeGuid("7bf1bf3d-3f35-4ed2-bb5c-3cc6de7f40bc");
 //   _AgentSearch.GoToUrl();
    ...
    _AgentSearch.Enter_ctl00cPHFiltertxtAgentName("Standard_set_agent");
...
pages.Searchclient _Searchclient = new pages.Searchclient(driver);
 //   TestModellerLogger.SetLastNodeGuid("6588bb30-8aa9-47e3-9c47-f23afcd5d814");
  //  _Searchclient.GoToUrl();
    ...
    _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("Standard_set_bussss");
...
pages.bankmenu _bankmenu = new pages.bankmenu(driver);
  ...
  TestModellerLogger.SetLastNodeGuid("cd431e1c-5f14-4042-85e6-c92307a9ba2b");
   ...
   pages.new_bank_trans.new_BANK_Trans _tr=new pages.new_bank_trans.new_BANK_Trans(driver);
   _tr.Standard_scheme_Spentamt();
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlCl2() throws Exception
    {
    	sTestCaseID="TC6";
    	Sheet="51ledgercode";
    	data =ExcelData.toReadExcelData(sTestCaseID, Sheet);
...
pages.AgentSearch _AgentSearch = new pages.AgentSearch(driver);
  ...
  //  _AgentSearch.GoToUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("9afd81f0-5ffc-4b6b-9602-9604f0d3d258");
    _AgentSearch.Enter_ctl00cPHFiltertxtAgentName("agent_set_flatrate");
...
pages.Searchclient _Searchclient = new pages.Searchclient(driver);
 ...
 //   _Searchclient.GoToUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("a71cb6de-7787-4e86-ac83-a09ab1ce3b13");
    _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("set_flatrate_buss");
...
_tr.Flaterate_scheme_spent();
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlCl3() throws Exception
    {
    	sTestCaseID="TC7";
    	Sheet="51ledgercode";
    	data =ExcelData.toReadExcelData(sTestCaseID, Sheet);
...
pages.AgentSearch _AgentSearch = new pages.AgentSearch(driver);
  ...
  //  _AgentSearch.GoToUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("9afd81f0-5ffc-4b6b-9602-9604f0d3d258");
    _AgentSearch.Enter_ctl00cPHFiltertxtAgentName("NOVAT_set_agent");
...
pages.Searchclient _Searchclient = new pages.Searchclient(driver);
  ...
  //  _Searchclient.GoToUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("a71cb6de-7787-4e86-ac83-a09ab1ce3b13");
    _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("NOVAT_set_buss");
