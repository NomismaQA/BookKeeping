...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/d7893516-0a21-4a20-9022-48c370331d66
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 766, profileId = 100658)
public class Login1VAT_DefaultProfile extends TestBase
{
    

    
    @Test  (groups= {"Login1VAT","Login1VAT - Default Profile"})
    @TestModellerPath(guid = "ccda8399-a6f1-4606-adf1-0eec422be1f2")
    public void GoToUrlAssertUrlPositiveEnterUserNamePositiveEnterPasswordClickLoginButton()
    {
    ...
    _Login1VAT.Enter_UserName("Rosemary.Hilll");
    

    TestModellerLogger.SetLastNodeGuid("95b31ed9-af0a-49e7-8bfa-8471d379cdff");
    _Login1VAT.Enter_Password("8KKRP7kKrB");
