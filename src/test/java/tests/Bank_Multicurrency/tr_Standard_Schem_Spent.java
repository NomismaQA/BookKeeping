...
public class tr_Standard_Schem_Spent extends TestBase
{
...
pages.Currency_Multi.Rec_Bank_Spent_AMTverify _amt1=new pages.Currency_Multi.Rec_Bank_Spent_AMTverify(driver);

_amt1.Click_transactionno_click();
_amt1.Click_Debit_Amount();
_amt1.Click_Credit_Amount1();
    }
...
_amt1.Click_Credit_Amount1();
    ...
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlC_setting() throws InterruptedException, IOException, InvalidFormatException
    {
...
//    _AgentSearch.AssertUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("9afd81f0-5ffc-4b6b-9602-9604f0d3d258");
    _AgentSearch.Enter_ctl00cPHFiltertxtAgentName("multi_agent");
//    
//    TestModellerLogger.SetLastNodeGuid("9afd81f0-5ffc-4b6b-9602-9604f0d3d258");
//    _AgentSearch.Select_status_dropdown("Show All");
//    
...
//    
    ...
    TestModellerLogger.SetLastNodeGuid("a71cb6de-7787-4e86-ac83-a09ab1ce3b13");
    _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("multi_busi");
...
_stcust.Click_Click_SalesInvoice_tab_3();
    ...
    utilities.PassScreenshot.Getscreenshot11("check currency opiton active or notST","Multicurrency");
