...
public class trFlat01schem_Spent extends TestBase
{
...
pages.Currency_Multi.FlatRate_Bank_Spent_AMTverify _amt4=new pages.Currency_Multi.FlatRate_Bank_Spent_AMTverify(driver);



_amt4.Click_transactionno_click();
_amt4.Click_Debit_Amount();
_amt4.Click_Credit_Amount1();
