...
public class tr_StandardSchem_Receivedamt extends TestBase
{
...
_amt.Click_Debit_Amount();
    ...
    @Test  (groups= {"1tr","1tr - nidbanktrn"})
    @TestModellerPath(guid = "e267114f-419d-45e6-885e-92b14bc1b012")
    public void nidbanktrnGoToUrlAssertUrlPositiveEnternLOGINPositiveEnternPASSClickLoginGoToUrlAssertUrlC_setting2() throws InterruptedException, IOException, InvalidFormatException
    {
    	sTestCaseID="TC_Setting multicurrency0";
    	Sheet="Multicurrency";
    	data =ExcelData.toReadExcelData(sTestCaseID, Sheet);
