...
public class SupplierBillSToFRS_DefaultProfile extends TestBase
{
    ...
    public void GoToUrlAssertUrlClickExpenditureTABClickNewTABClickNewSupplierBillPositiveSelectSupplierNameE1() throws InterruptedException, HeadlessException, IOException, AWTException
    {
    ...
    _SupplierBillSToFRS.Enter_Description("asd");
