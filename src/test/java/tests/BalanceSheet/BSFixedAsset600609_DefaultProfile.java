...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/c3964aca-3cdc-4e73-8cc7-3aa677cb4a95
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 532, profileId = 100442)
public class BSFixedAsset600609_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"c1784b5d-0cd8-44a9-93d6-8a0d44c4e18e","BS_FixedAsset-600-609","BS_FixedAsset-600-609 - Default Profile"})
    @TestModellerPath(guid = "c1784b5d-0cd8-44a9-93d6-8a0d44c4e18e")
    ...
    {
    	sTestCaseID="BSFixedAsset600609";
    	Sheet="BalanceSheet";
