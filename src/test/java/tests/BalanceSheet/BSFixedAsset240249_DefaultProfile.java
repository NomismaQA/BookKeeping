...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/9d2d9b32-b8c8-4a74-93ef-77e5eb7ab3ea
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 506, profileId = 100421)
public class BSFixedAsset240249_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"06df66e0-fbd8-497f-a66c-23be6988891c","BS_FixedAsset-240-249","BS_FixedAsset-240-249 - Default Profile"})
    @TestModellerPath(guid = "06df66e0-fbd8-497f-a66c-23be6988891c")
    ...
    {
    	sTestCaseID="BSFixedAsset240249";
    	Sheet="BalanceSheet";
