...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/e56ddece-542e-40c5-a511-cabfc2053880
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 498, profileId = 100414)
public class BSFixedAsset4049_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"6be5feeb-49f9-4839-8f0b-cec9c2ab40c4","BS_FixedAsset-40-49","BS_FixedAsset-40-49 - Default Profile"})
    @TestModellerPath(guid = "6be5feeb-49f9-4839-8f0b-cec9c2ab40c4")
