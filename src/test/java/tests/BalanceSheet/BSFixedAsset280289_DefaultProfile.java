...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/1249ef9c-2a11-43b0-9fbe-df6d691b9a60
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 530, profileId = 100440)
public class BSFixedAsset280289_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"7eb4d349-3e28-4e35-832c-f75161834118","BS_FixedAsset-280-289","BS_FixedAsset-280-289 - Default Profile"})
    @TestModellerPath(guid = "7eb4d349-3e28-4e35-832c-f75161834118")
    ...
    {
    	sTestCaseID="BSFixedAsset280289";
    	Sheet="BalanceSheet";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    //TestModellerLogger.SetLastNodeGuid("335212ec-d991-4d36-b04a-604fd17dccf5");
    //_pagesAddjournalEntry10incBnk.Senddata_AccountTextbox();
    //Senddata_AccountTextbox
