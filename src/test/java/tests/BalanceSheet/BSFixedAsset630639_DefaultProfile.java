...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/8ca594c1-4370-48b5-a834-f8f1cdc76112
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 533, profileId = 100443)
public class BSFixedAsset630639_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"744b8f4b-0a72-4844-ac1f-d3ba0dacc20d","BS_FixedAsset-630-639","BS_FixedAsset-630-639 - Default Profile"})
    @TestModellerPath(guid = "744b8f4b-0a72-4844-ac1f-d3ba0dacc20d")
    ...
    {
    	sTestCaseID="BSFixedAsset630639";
    	Sheet="BalanceSheet";
