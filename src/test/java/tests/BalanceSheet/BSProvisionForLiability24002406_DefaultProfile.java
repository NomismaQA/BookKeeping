...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/dd89c454-0d7f-45ad-b45d-c0532340782c
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 534, profileId = 100444)
public class BSProvisionForLiability24002406_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"d0249a6f-ef33-48a5-b8af-3a412f7c1d42","BS_ProvisionForLiability-2400-2406","BS_ProvisionForLiability-2400-2406 - Default Profile"})
    @TestModellerPath(guid = "d0249a6f-ef33-48a5-b8af-3a412f7c1d42")
    ...
    {
    	sTestCaseID="BSProvisionForLiability24002406";
    	Sheet="BalanceSheet";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    //_pagesAddjournalEntry10incBnk.Enter_Credit6("");
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_ProvisionForLiability();
