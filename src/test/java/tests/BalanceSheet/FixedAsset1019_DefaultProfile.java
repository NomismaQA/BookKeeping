...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/e17cdbb7-ef8c-47f0-961e-44002d722b8b
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 495, profileId = 100410)
public class FixedAsset1019_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"8813c1df-a344-43fe-b828-4f8341821241","FixedAsset-10-19","FixedAsset-10-19 - Default Profile"})
    @TestModellerPath(guid = "8813c1df-a344-43fe-b828-4f8341821241")
