...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/bd9fdae1-b033-4b36-834b-c81c67dc55d9
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 508, profileId = 100423)
public class BSFixedAsset250259_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"67fd71b7-b953-4172-a659-f7474ca295e7","BS_FixedAsset-250-259","BS_FixedAsset-250-259 - Default Profile"})
    @TestModellerPath(guid = "67fd71b7-b953-4172-a659-f7474ca295e7")
    ...
    {
    	sTestCaseID="BSFixedAsset250259";
    	Sheet="BalanceSheet";
