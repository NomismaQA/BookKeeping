...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/82b7cfa5-da59-479a-8f36-82fc70a8f5f9
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 529, profileId = 100439)
public class BSFixedAsset270279_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"9b02c365-3270-4b7e-9d35-9ad5eef703c2","BS_FixedAsset-270-279","BS_FixedAsset-270-279 - Default Profile"})
    @TestModellerPath(guid = "9b02c365-3270-4b7e-9d35-9ad5eef703c2")
    ...
    {
    	sTestCaseID="BSFixedAsset270279";
    	Sheet="BalanceSheet";
