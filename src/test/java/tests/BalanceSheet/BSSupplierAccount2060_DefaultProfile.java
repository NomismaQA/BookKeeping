...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/61ab2ac7-1742-4c4d-bb03-33433d2162f2
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 540, profileId = 100450)
public class BSSupplierAccount2060_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"b0bc0242-9f99-4917-bcd7-ecefecf44e6b","BS_Supplier Account-2060","BS_Supplier Account-2060 - Default Profile"})
    @TestModellerPath(guid = "b0bc0242-9f99-4917-bcd7-ecefecf44e6b")
    ...
    {
    	sTestCaseID="BSSupplierAccount2060";
    	Sheet="BalanceSheet";
