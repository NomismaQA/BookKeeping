...
public class BSFixedAsset230239_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"74858035-41ef-4278-8710-9bbce6be7bd2","BS_FixedAsset-230-239","BS_FixedAsset-230-239 - Default Profile"})
    @TestModellerPath(guid = "74858035-41ef-4278-8710-9bbce6be7bd2")
    ...
    {
    	sTestCaseID="BSFixedAsset230239";
    	Sheet="BalanceSheet";
