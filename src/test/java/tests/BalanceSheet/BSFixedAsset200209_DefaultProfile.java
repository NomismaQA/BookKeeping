...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/e4cf1e4a-ffcc-426f-9aa8-2bdc77bd5a73
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 499, profileId = 100415)
public class BSFixedAsset200209_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"76817554-36d8-46ca-98f5-b2cb5d2a5e0f","BS_FixedAsset-200-209","BS_FixedAsset-200-209 - Default Profile"})
    @TestModellerPath(guid = "76817554-36d8-46ca-98f5-b2cb5d2a5e0f")
    ...
    {
    	sTestCaseID="BSFixedAsset200209";
    	Sheet="BalanceSheet";
