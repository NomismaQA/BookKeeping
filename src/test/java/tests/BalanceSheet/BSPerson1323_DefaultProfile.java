...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/87e9653c-5a5f-4c63-add5-aa5fc14efe53
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 536, profileId = 100446)
public class BSPerson1323_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"28014648-e326-4684-93b2-5a7d2f29b645","BS_Person-1323","BS_Person-1323 - Default Profile"})
    @TestModellerPath(guid = "28014648-e326-4684-93b2-5a7d2f29b645")
    ...
    {
    	sTestCaseID="LB_Bf_Person_1323_2";
    	Sheet="BalanceSheet";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_Person_1323();
