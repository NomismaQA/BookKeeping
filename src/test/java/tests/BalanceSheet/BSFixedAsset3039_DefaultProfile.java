...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/a1e96ebd-b1d6-44f7-9b2c-3a8f6b49079f
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 497, profileId = 100413)
public class BSFixedAsset3039_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"12c7daa9-8410-43b8-b1ce-65c41acff207","BS_FixedAsset-30-39","BS_FixedAsset-30-39 - Default Profile"})
    @TestModellerPath(guid = "12c7daa9-8410-43b8-b1ce-65c41acff207")
