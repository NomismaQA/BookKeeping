...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/b3e458ba-168e-4755-94d2-3184aaf184f0
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 526, profileId = 100437)
public class BSCreditorDueAfterOneYear23002331_DefaultProfile extends TestBase
{
	String sTestCaseID=null;
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"d29dab36-f1e2-4ae8-a37a-ba7af1ee39d6","BS_CreditorDueAfterOneYear-2300-2331","BS_CreditorDueAfterOneYear-2300-2331 - Default Profile"})
    @TestModellerPath(guid = "d29dab36-f1e2-4ae8-a37a-ba7af1ee39d6")
    ...
    {
    	sTestCaseID="BSCreditorDueAfterOneYear23002331";
    	Sheet="BalanceSheet";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
   ...
   // TestModellerLogger.SetLastNodeGuid("d7c5d242-62f4-4eb9-80a8-730645de5a35");
    //_pagesAddjournalEntry10incBnk.Enter_Debit8("1700");
    

    TestModellerLogger.SetLastNodeGuid("33a9fe25-0531-4aa3-8446-b55cc15c78a0");
    _pagesAddjournalEntry10incBnk.Enter_Credit8(sData[23]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_CreditorDueAfterYear_2300_2331();
