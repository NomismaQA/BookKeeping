...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/44ef3065-e235-45d9-85dd-b96e353ceb5d
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 516, profileId = 100429)
public class BSCurrentAsset10001450_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"92bc9d3e-5e23-48b3-9cc0-9b8dac0cc59f","BS_CurrentAsset-1000-1450","BS_CurrentAsset-1000-1450 - Default Profile"})
    @TestModellerPath(guid = "92bc9d3e-5e23-48b3-9cc0-9b8dac0cc59f")
    ...
    {
    	sTestCaseID="BSCurrentAsset10001450";
    	Sheet="BalanceSheet";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
   ...
   // _pagesAddjournalEntry10incBnk.Enter_Debit6("1500");
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    _pagesAddjournalEntry10incBnk.verify_BS_CurrentAsset_1000_1450();
