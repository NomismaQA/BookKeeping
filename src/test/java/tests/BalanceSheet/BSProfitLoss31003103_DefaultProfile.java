...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/9b509d51-5104-47bd-8129-d49e0a5f7952
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 543, profileId = 100453)
public class BSProfitLoss31003103_DefaultProfile extends TestBase
{
    ...
    String[] sData=null;
    String Sheet =null;
    @Test  (retryAnalyzer = RetryAnalyzer.class,groups= {"a1203137-7b3f-49c8-b126-13549cdd604b","BS_ProfitLoss-3100_3103","BS_ProfitLoss-3100_3103 - Default Profile"})
    @TestModellerPath(guid = "a1203137-7b3f-49c8-b126-13549cdd604b")
    ...
    {
    	sTestCaseID="BSProfitLoss31003103";
    	Sheet="BalanceSheet";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    _pagesAddjournalEntry10incBnk.verify_BS_ProfitLoss_3103(sData[23],sData[24],sData[11],sData[12],sData[20]);
