...
public class TC_48_BSBFPerson1323_DefaultProfile extends TestBase
{
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_48_BSBF_Person_1323_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[12]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_Bf_Person_1323_1();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_48_BSBF_Person_1323_NextFollowingYear_With JournalEntry");
    ...
    {
    	sTestCaseID="BSBF_Person1323_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_48_BSBF_Person_1323_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_48_BSBF_Person_1323_NextFollowingYear_With JournalEntry_Expense_Bank");
