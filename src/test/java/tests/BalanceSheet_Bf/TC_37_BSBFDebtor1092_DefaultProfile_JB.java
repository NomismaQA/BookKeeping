...
public class TC_37_BSBFDebtor1092_DefaultProfile_JB extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_OtherDebtor1092";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Credit2(data[11]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_37_BSBF_Debtor_1092_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[12]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_Customer_1070_();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_37_BSBF_Debtor_1092_NextFollowingYear_With JournalEntry");
...
//    {
//    	sTestCaseID="BSBF_Customer_1070_BE";
//       	Sheet="BalanceSheetBf";
//        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
//        
//        pages.nlogin _nlogin = new pages.nlogin(driver);
...
//  _SaleInvoice.Enter_Description(data[7]);
//  
//
//  TestModellerLogger.SetLastNodeGuid("73677a32-1892-47f6-9783-a1072478778a");
//  _SaleInvoice.Enter_UnitPrice(data[9]);
//  
//
...
//  _pagesverifyBS.Click_Balance_Sheet_link();
//  
//  utilities.Screenshotcapture.FullScreenshot1("TC_33_BSBF_Customer_1070_With JournalEntry_Expense");
//  
//  TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
//  _pagesverifyBS.Select_selectFinancialYear(data[12]);
//  
...
//  
//   
//   utilities.Screenshotcapture.FullScreenshot2("TC_33_BSBF_Customer_1070_NextFollowingYear_With JournalEntry_Expense");
//}
    ...
    {
    	sTestCaseID="BSBF_OtherDebtor1092_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_37_BSBF_Debtor_1092_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_37_BSBF_Debtor_1092_NextFollowingYear_With JournalEntry_Expense_Bank");
