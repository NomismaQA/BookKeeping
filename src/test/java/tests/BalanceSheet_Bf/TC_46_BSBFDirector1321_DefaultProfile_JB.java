...
public class TC_46_BSBFDirector1321_DefaultProfile_JB extends TestBase
{
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account1_way3(data[8]);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account2_way3(data[10]);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account3_way3(data[12]);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account4_way3(data[14]);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account5_way3(data[16]);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account6(data[18]);
    _pagesAddjournalEntry10incBnk.Enter_Credit6(data[19]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_46_BSBFDirector1321_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[20]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_Director_1321();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_46_BSBFDirector1321_NextFollowingYear_With JournalEntry");
...
//    {
//    	sTestCaseID="BSBF_FixedAsset1014_BE";
//       	Sheet="BalanceSheetBf";
//        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
//        
//        pages.nlogin _nlogin = new pages.nlogin(driver);
...
////
////  TestModellerLogger.SetLastNodeGuid("7ea52093-1dd7-4979-8034-aeaef336d945");
////  _SupplierBillSToFRS.Select_ExpenseType(data[30]);
////  
////
////  TestModellerLogger.SetLastNodeGuid("de8f87b1-ff3a-421c-9290-6ddaef339bf2");
////  _SupplierBillSToFRS.Enter_Description(data[8]);
...
////_DebitNoteSToFRS.Select_ExpenseType(data[17]);
////
////
...
////_DebitNoteSToFRS.Enter_UnitPrice(data[18]);
////s
////
////
...
//  _pagesverifyBS.Click_Balance_Sheet_link();
//  
//  utilities.Screenshotcapture.FullScreenshot1("TC_01_BSBF_FixedAsset1014_With JournalEntry_Expense");
//  
//  TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
...
//  
//   
//   utilities.Screenshotcapture.FullScreenshot2("TC_01_BSBF_FixedAsset1014_NextFollowingYear_With JournalEntry_Expense");
//}
//    
...
utilities.Screenshotcapture.FullScreenshot1("TC_46_BSBFDirector1321_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_46_BSBFDirector1321_NextFollowingYear_With JournalEntry_Expense_Bank");
