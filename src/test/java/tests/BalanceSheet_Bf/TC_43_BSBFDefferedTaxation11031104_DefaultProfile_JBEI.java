...
@TestModellerSuite(id = 598, profileId = 100451)
public class TC_43_BSBFDefferedTaxation11031104_DefaultProfile_JBEI extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_11031104_io";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_43_BSBF_Taxation11031104_With Invoice_Expense");
...
pages.AddjournalEntry10incBnkOld _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnkOld(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_43_BSBF_Taxation11031104_NextFollowingYear_With Invoice_Expense");
...
//_pagesDel_Bill.Click_Success_msg();  
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_11031104";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_43_BSBF_Taxation11031104_With JournalEntry");
    ...
    utilities.Screenshotcapture.FullScreenshot2("TC_43_BSBF_Taxation11031104_NextFollowingYear_With JournalEntry");
...
//}
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_11031104_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_43_BSBF_Taxation11031104_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_43_BSBF_Taxation11031104_NextFollowingYear_With JournalEntry_Expense_Bank");
