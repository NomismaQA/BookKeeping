...
public class TC_24_BSBFFixedAsset275279_DefaultProfile extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_FixedAsset275279";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_24_BSBF_FixedAsset275279_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[18]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_275_279(data[19], data[20]);
    
    utilities.Screenshotcapture.FullScreenshot2("TC_24_BSBF_FixedAsset275279_NextFollowingYear_With JournalEntry");
    ...
    {
    	sTestCaseID="BSBF_FixedAsset275279_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
