...
public class TC_32_BSBFProfitLoss30073010_DefaultProfile extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_Profitloss_30073010";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_32_BSBFProfitLoss30073010_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[14]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_31073110(data[15], data[16]);
    
    utilities.Screenshotcapture.FullScreenshot2("TC_32_BSBFProfitLoss30073010_NextFollowingYear_With JournalEntry");
    ...
    {
    	sTestCaseID="BSBF_Profitloss_30073010_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_32_BSBFProfitLoss30073010_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_32_BSBFProfitLoss30073010_NextFollowingYear_With JournalEntry_Expense_Bank");
