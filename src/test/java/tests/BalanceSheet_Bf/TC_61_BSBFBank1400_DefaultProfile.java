...
public class TC_61_BSBFBank1400_DefaultProfile extends TestBase
{
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_61_BSBFBank1400_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[12]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_Bank1400_();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_61_BSBFBank1400_NextFollowingYear_With JournalEntry");
...
utilities.Screenshotcapture.FullScreenshot1("TC_61_BSBFBank1400_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_61_BSBFBank1400_NextFollowingYear_With JournalEntry_Expense_Bank");
