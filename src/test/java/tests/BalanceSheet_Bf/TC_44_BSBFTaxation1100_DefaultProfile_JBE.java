...
public class TC_44_BSBFTaxation1100_DefaultProfile_JBE extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_1100";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Credit1(data[9]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_44_BSBF_Taxation1100__With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[12]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_SupplierAccount_2060();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_44_BSBF_Taxation1100_NextFollowingYear_With JournalEntry");
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_1100_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
//  
 ...
 //  Bk.Supplier();
  ...
  //  _Expense_Reimbursement.Select_Employee_32("Mohd Ashiv");
    ...
    _Expense_Reimbursement.Enter_Enter_Description_33(data[13]);
    

    TestModellerLogger.SetLastNodeGuid("a108145a-b34f-468f-aa6e-254fdb207f61");
    _Expense_Reimbursement.Enter_Enter_Date_34(data[6]);
    

    TestModellerLogger.SetLastNodeGuid("c5575379-f428-4faf-8307-8ddd3302dcbf");
    _Expense_Reimbursement.Select_Select_Paid_to_35(data[14]);
    

    TestModellerLogger.SetLastNodeGuid("4a345460-91c1-4a15-a45b-8eae32bae11b");
    _Expense_Reimbursement.Enter_Enter_Amount_36(data[15]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
  ...
  utilities.Screenshotcapture.FullScreenshot1("TC_44_BSBF_Taxation1100_With JournalEntry_Expense");
  ...
  //_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
   ...
   utilities.Screenshotcapture.FullScreenshot2("TC_44_BSBF_Taxation1100_NextFollowingYear_With JournalEntry_Expense");
...
utilities.Screenshotcapture.FullScreenshot1("TC_44_BSBF_Taxation1100_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_44_BSBF_Taxation1100_NextFollowingYear_With JournalEntry_Expense_Bank");
