...
public class TC_45_BSBFTaxation2402_DefaultProfile_JB extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_2402";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_45_BSBFTaxation2402_With JournalEntry");
    ...
    utilities.Screenshotcapture.FullScreenshot2("TC_45_BSBFTaxation2402_NextFollowingYear_With JournalEntry");
...
//    {
//    	sTestCaseID="BSBF_Supplier_2060_BE";
//       	Sheet="BalanceSheetBf";
//        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
//        
//        pages.nlogin _nlogin = new pages.nlogin(driver);
...
//  _pagesverifyBS.Click_Balance_Sheet_link();
//  
//  utilities.Screenshotcapture.FullScreenshot1("TC_40_BSBF_TradeCreditor2060_With JournalEntry_Expense");
//  
//  TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
//  _pagesverifyBS.Select_selectFinancialYear(data[12]);
//  
...
//  
//   
//   utilities.Screenshotcapture.FullScreenshot2("TC_40_BSBF_TradeCreditor2060_NextFollowingYear_With JournalEntry_Expense");
//}
    ...
    {
    	sTestCaseID="BSBF_DeffTaxation_2402_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_45_BSBFTaxation2402_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_45_BSBFTaxation2402_NextFollowingYear_With JournalEntry_Expense_Bank");
