...
public class TC_60_BSBF_CurrentAsset1000_1060_DefaultProfile extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_CurrentAsset1000_1060";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Account1_R(data[8]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_60_BSBF_CurrentAsset1000_1060_With JournalEntry");
    
    _pagesAddjournalEntry10incBnk.verify_BS_1000_1060();
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[14]);
    
    
    _pagesAddjournalEntry10incBnk.verify_BS_1000_1060_Profitloss(data[15], data[16], data[13]);
    
    utilities.Screenshotcapture.FullScreenshot2("TC_60_BSBF_CurrentAsset1000_1060_NextFollowingYear_With JournalEntry");
    ...
    {
    	sTestCaseID="BSBF_CurrentAsset1000_1060_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_60_BSBF_CurrentAsset1000_1060__With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_60_BSBF_CurrentAsset1000_1060_NextFollowingYear_With JournalEntry_Expense_Bank");
