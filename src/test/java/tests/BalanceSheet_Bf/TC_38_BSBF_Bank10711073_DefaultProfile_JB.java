...
public class TC_38_BSBF_Bank10711073_DefaultProfile_JB extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_PaymentType1071_1073";
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_38_BSBF_PaymentType10711073_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[16]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_BF_PaymentType_1071_1073();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_38_BSBF_PaymentType10711073_NextFollowingYear_With JournalEntry");
...
//    
    ...
    {
    	sTestCaseID="BSBF_PaymentType1071_1073_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_38_BSBF_PaymentType10711073_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_38_BSBF_PaymentType10711073_NextFollowingYear_With JournalEntry_Expense_Bank");
