...
public class TC_57_BSBFProvisionForLiability24042406_DefaultProfile extends TestBase
{
    ...
    {
    	sTestCaseID="BSBF_ProvisionForLiability2404_2406";
...
pages.AddjournalEntry10incBnk _pagesAddjournalEntry10incBnk = new pages.AddjournalEntry10incBnk(driver);
    ...
    _pagesAddjournalEntry10incBnk.Enter_Credit4(data[15]);
...
pages.verifyBS _pagesverifyBS = new pages.verifyBS(driver);
    ...
    utilities.Screenshotcapture.FullScreenshot1("TC_57_BSBFProvisionForLiability24042406_With JournalEntry");
    
    TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
    _pagesverifyBS.Select_selectFinancialYear(data[16]);
    
    _pagesAddjournalEntry10incBnk.verify_BS_BF_ProvisionForLiability();
    
    utilities.Screenshotcapture.FullScreenshot2("TC_57_BSBFProvisionForLiability24042406_NextFollowingYear_With JournalEntry");
...
//    {
//    	sTestCaseID="BSBF_FixedAsset635639_BE";
//       	Sheet="BalanceSheetBf";
//        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
//        
//        pages.nlogin _nlogin = new pages.nlogin(driver);
...
//  _pagesverifyBS.Click_Balance_Sheet_link();
//  
//  utilities.Screenshotcapture.FullScreenshot1("TC_30_BSBF_FixedAsset6355639_With JournalEntry_Expense");
//  
//  TestModellerLogger.SetLastNodeGuid("489eb3fd-e97e-49f7-aba2-610610f074e6");
//  _pagesverifyBS.Select_selectFinancialYear(data[16]);
//  
...
//  
//   
//   utilities.Screenshotcapture.FullScreenshot2("TC_30_BSBF_FixedAsset6355639_NextFollowingYear_With JournalEntry_Expense");
//}
//    
    ...
    {
    	sTestCaseID="BSBF_ProvisionForLiability2404_2406_BE";
       	Sheet="BalanceSheetBf";
        data = ExcelUtility.toReadExcelData(sTestCaseID, Sheet);
...
utilities.Screenshotcapture.FullScreenshot1("TC_57_BSBFProvisionForLiability24042406_With JournalEntry_Expense_Bank");
...
//_pagesAddjournalEntry10incBnk.verify_BS_BF_FixedAsset_10_14(data[19], data[20]);
 ...
 utilities.Screenshotcapture.FullScreenshot2("TC_57_BSBFProvisionForLiability24042406_NextFollowingYear_With JournalEntry_Expense_Bank");
