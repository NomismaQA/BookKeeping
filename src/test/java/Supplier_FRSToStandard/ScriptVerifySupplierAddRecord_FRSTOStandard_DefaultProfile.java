...
//https://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/9c3d29c6-2b04-4187-8581-5f6c412743f1
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 1123, profileId = 101018)
public class ScriptVerifySupplierAddRecord_FRSTOStandard_DefaultProfile extends TestBase
{
    ...
    @Test  (groups= {"ScriptVerifySupplierAddRecordSTOFRS","ScriptVerifySupplierAddRecordSTOFRS - Default Profile"})
    @TestModellerPath(guid = "5152e916-97f2-4047-91ce-e767a922128f")
