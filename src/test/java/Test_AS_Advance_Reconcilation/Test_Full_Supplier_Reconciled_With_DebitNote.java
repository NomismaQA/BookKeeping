...
public class Test_Full_Supplier_Reconciled_With_DebitNote extends TestBase
{
 ...
 {
 	sTestCaseID="TC400SupplierWithDebitNoteFull";
    	Sheet="Fin-3821";
...
_DebitNoteSToFRS.Enter_BillNo("Ashiv");
...
_DebitNoteSToFRS.Select_VATRateType(data[9]);
...
_PartialReconcilationLAtest.click_Adem();
 ...
 _PartialReconcilationLAtest.Fullreconcilation();
 
 _PartialReconcilationLAtest.ViewRecon(data[20], data[5]);
 
 _PartialReconcilationLAtest.Full_Supplier_Reconcilation_With_DebitNote();
 
 Pages_Reconcilation_TC.SupplierBillSToFRS _SupplierBillSToFRS1 = new Pages_Reconcilation_TC.SupplierBillSToFRS(driver);

 TestModellerLogger.SetLastNodeGuid("5c30d940-2a3c-4ce2-9f6d-f491e71a1755");
 _SupplierBillSToFRS1.Click_ExpenditureTAB();

 _SupplierBillSToFRS1.Search("Supplier Name", data[5]);

 _SupplierBillSToFRS1.SupplierReconWithDebitNote();
