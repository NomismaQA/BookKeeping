...
public class Test_Advance_CreditNote_Reconcilation_Bnk extends TestBase
{
...
_PartialReconcilationLAtest.click_Adem();
 ...
 _PartialReconcilationLAtest.Advance_Credit_Rec_screenshot2();
 ...
 _Ledger_Reconciliation2.Click_Sale_1();
  ...
  _Ledger_Reconciliation2.dsbBlanceZeroCreditWithBnk();
	...
	Pages_Reconcilation_TC.NewPreviewPage _NewPreviewPage = new Pages_Reconcilation_TC.NewPreviewPage(driver);
	 ...
	 //   _NewPreviewPage.AssertUrl();
	    ...
	    _NewPreviewPage.ScreenshotCreditnoteWithbank();
