...
public class Test_Advance_DebitNote_Reconcilation_WithBank extends TestBase
{
 ...
 {
 	sTestCaseID="TC400DebitNoteWithBank";
    	Sheet="Fin-3821";
...
_PartialReconcilationLAtest.click_Adem();
 ...
 _PartialReconcilationLAtest.Advance_DebitNote_Reconcilation();
 ...
 _SupplierBillSToFRS.AdvanceDebitNoteScreenshot();
