...
import Trial_Balance.Delete_Bank_entry;
...
public class TC_37_05_ExpenseHead_72545758__JournalEntry_Bank_Supplier extends TestBase
{
...
pages.PartialReconciledCases.Searchclient _Searchclient = new pages.PartialReconciledCases.Searchclient(driver);
 ...
 //  _JournalEntry.Enter_Reverse_Date(data[6]);
   ...
   _JournalEntry.Enter_ClickaccountboxSpl(data[9]);
...
//   _JournalEntry.verifyData();
   ...
   utilities.Screenshotcapture.FullScreenshot("TC_37_5_ExpenseHead_72545758_jurnalEntry");
//   
//   
    }
...
//    _JournalEntry.verifyData();
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_37_5_ExpenseHead_72545758_With_BankEntry");
    }
    @Test  (groups= {"SaleInToReconcile","SaleInToReconcile - Default Profile"})
    @TestModellerPath(guid = "8c7c840e-6086-4f3d-b9ff-7b3f3724775c")
...
utilities.Screenshotcapture.FullScreenshot("TC_37_5_ExpenseHead_72545758_JurnalEntry_BankEntry_Supplier");
