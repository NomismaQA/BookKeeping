...
public class TC_40_3_ExpenseHead_7500_7527__JournalEntry_Bank_Supplier extends TestBase
{
...
//   _JournalEntry.verifyData();
   ...
   utilities.Screenshotcapture.FullScreenshot("TC_40_jurnalEntry");
//   
//   
    }
...
//    _JournalEntry.verifyData();
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_40_journalEntry_With_BankEntry");
    }
    @Test  (groups= {"SaleInToReconcile","SaleInToReconcile - Default Profile"})
    @TestModellerPath(guid = "8c7c840e-6086-4f3d-b9ff-7b3f3724775c")
...
utilities.Screenshotcapture.FullScreenshot("TC_40_jurnalEntry_BankEntry_Supplier");
