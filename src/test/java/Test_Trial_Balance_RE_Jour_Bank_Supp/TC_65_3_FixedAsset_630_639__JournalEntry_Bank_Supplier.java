...
public class TC_65_3_FixedAsset_630_639__JournalEntry_Bank_Supplier extends TestBase
{
...
//   _JournalEntry.verifyData();
   ...
   utilities.Screenshotcapture.FullScreenshot("TC_65_jurnalEntry_Value In Fixed Asset");
//   
//   
    }
...
//    _JournalEntry.verifyData();
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_65_journalEntry_With_BankEntry_Value In Fixed Asset");
    }
    @Test  (groups= {"SaleInToReconcile","SaleInToReconcile - Default Profile"})
    @TestModellerPath(guid = "8c7c840e-6086-4f3d-b9ff-7b3f3724775c")
...
utilities.Screenshotcapture.FullScreenshot("TC_65_jurnalEntry_BankEntry_Supplier_Value In Fixed Asset");
