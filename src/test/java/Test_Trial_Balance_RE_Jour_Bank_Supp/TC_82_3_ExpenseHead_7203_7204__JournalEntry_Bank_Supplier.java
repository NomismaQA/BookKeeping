...
public class TC_82_3_ExpenseHead_7203_7204__JournalEntry_Bank_Supplier extends TestBase
{
...
//   _JournalEntry.verifyData();
   ...
   utilities.Screenshotcapture.FullScreenshot("TC_82_jurnalEntry");
//   
//   
    }
...
//    _JournalEntry.verifyData();
    ...
    utilities.Screenshotcapture.FullScreenshot("TC_82_journalEntry_With_BankEntry");
    }
    @Test  (groups= {"SaleInToReconcile","SaleInToReconcile - Default Profile"})
    @TestModellerPath(guid = "8c7c840e-6086-4f3d-b9ff-7b3f3724775c")
...
utilities.Screenshotcapture.FullScreenshot("TC_82_jurnalEntry_BankEntry_Supplier");
